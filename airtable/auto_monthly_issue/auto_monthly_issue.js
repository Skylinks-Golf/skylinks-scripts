...
const VIEW_NAME  = "Handyman";                    // optional: where it should appear
const TITLE_FLD  = "Title";                       // adjust to match your schema
...
const CREATED_FLD = "Created";                    // optional: Created time field (type = Created time)
...
const guardFields = [TITLE_FLD, STATUS_FLD];
...
const recentSameOpen = query.records.some(r => {
  ...
  if (!sameTitle || !isOpen) return false;
